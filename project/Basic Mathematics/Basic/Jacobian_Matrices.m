...
clear
syms L1 L2 L3 L5 L6 L4 d1 d2 theta1 theta2 theta3 theta4 theta5 theta6
...
% Midterm_6R(5) = Link([theta5  L6+d1  L5  pi/2],'modified');
% Midterm_6R(6) = Link([0  0  d2  0],'modified');
...
% Robot(5) = Link([theta5  L6+d1  L5  pi/2],'modified');
% Robot(6) = Link([0  0  d2  0],'modified');
